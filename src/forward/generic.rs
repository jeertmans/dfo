//! Forward automatic differentiation implemented on generic types.
...
impl<'de, T> Deserialize<'de> for DFloat<T>
where
    T: Deserialize,
{
...
#[cfg(feature = "num-traits")]
impl<T> Differentiable for DFloat<T>
where
    T: One + Zero,
{
    type Inner = T;
